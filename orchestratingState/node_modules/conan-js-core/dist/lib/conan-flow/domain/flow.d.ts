...
export interface Flow<STATUSES, MUTATORS extends Mutators<STATUSES> = VoidMutators<STATUSES>> {
    isRunning: boolean;
    ...
    addReactionNext<STATUS extends keyof STATUSES & keyof MUTATORS>(statusDef: StatusDef<STATUSES, STATUS, MUTATORS>, reaction: ReactionDef<STATUSES, STATUS, MUTATORS>): this;
    ...
    chainInto<STATUS_FROM extends keyof STATUSES, STATUS_TO extends keyof STATUSES>(statusFrom: STATUS_FROM, statusTo: STATUS_TO, mutatorsCb: IConsumer<MUTATORS[STATUS_FROM]>, name?: string): Asap<Context<STATUSES, STATUS_TO, MUTATORS>>;
