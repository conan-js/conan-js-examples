...
export declare type StatusesDef<STATUSES> = {
    [STATUS in keyof STATUSES]: StatusDef<STATUSES, STATUS>;
};
export interface StatusDef<STATUSES, STATUS extends keyof STATUSES, MUTATORS extends Mutators<STATUSES> = VoidMutators<STATUSES>> {
    name: string;
