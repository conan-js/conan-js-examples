...
export declare class Objects {
    static mapKeys<VALUE_TYPE, FINAL_VALUE_TYPE = VALUE_TYPE>(from: IKeyValuePairs<any>, valueMapper: IFunction<VALUE_TYPE, FINAL_VALUE_TYPE>, keyMapper?: IReducer<string>): IKeyValuePairs<FINAL_VALUE_TYPE>;
