...
export interface FlowDef<STATUSES, MUTATORS extends Mutators<STATUSES> = VoidMutators<STATUSES>> {
    name: string;
    statusesByStatusName: {
        [STATUS in keyof STATUSES]: StatusDef<STATUSES, STATUS, MUTATORS>;
    };
