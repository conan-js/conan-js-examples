...
export declare class Pipes {
    static fromMonitor<FROM, INTO, ACTIONS = void>(monitor: MonitorFacade<FROM>, monitorMerger: (ITriFunction<MonitorInfo, FROM, INTO, INTO>), dataMerger: ITriFunction<FROM, MonitorInfo, INTO, INTO>, pipeThreadDef?: PipeThreadDef<INTO, {}, ACTIONS>): ThreadFacade<INTO, {}, ACTIONS>;
