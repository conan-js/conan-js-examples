...
class FlowDefFactory {
    static create(userFlowDef, flowAnchor) {
        ...
        return Object.assign({ statusesByStatusName: statusesByStatusName, name: userFlowDef.name }, userFlowDef.hasOwnProperty('initialStatus') ? { starter: () => userFlowDef.initialStatus } : undefined);
    }
...
class ConanState {
    ...
    asyncMerge(baseValue, monitorMerger, dataMerger) {
        ...
        let mergedThread = Pipes.fromMonitor(this.state, monitorMerger, dataMerger, {
